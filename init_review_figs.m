...
% 		'Style', 'edit', 'String', '-100');
	...
	uicontrol('Style', 'text', 'Units', 'normalized', ...
		'Position', [0.93 0.39 0.063 0.0464], 'Fontsize', analysis_label_fontsize, ...
		'String', 'Num Std Deviations', ...
		'HorizontalAlignment', 'left')
	app.h_num_std = uicontrol('Style', 'edit', ...
		'Units', 'normalized', 'Position', [0.93 0.36 0.06 0.03], ...
		'Tag', 'edit_num_std', ...
	...
	app.h_compute_close_mep_begin = uicontrol('Style', 'pushbutton', ...
		...
		'String', '<html>Move MEP begin line to the right<br />where mean line exceeds the<br />prestim std dev</html>', ...
