...
% 		'Style', 'edit', 'String', '-100');
	...
	app.h_autocompute_mep = uicontrol('Style', 'pushbutton', ...
		'Units', 'normalized', 'Position', [0.6 0.3 0.165 0.03], ...
		'Tag', 'autocompute_mep_pushbutton', ...
		'String', 'Compute MEP begin', 'fontsize', 16, 'Value', 0, ...
		'Callback', {@pushbutton_compute_mep_beg, app});
   
	app.h_compute_close_mep_begin = uicontrol('Style', 'pushbutton', ...
		'Units', 'normalized', 'Position', [0.6,0.24,0.165,0.06], ...
		'FontSize', 12, ...
		'String', '<html>Move MEP begin line to the left<br />where mean line derivative = 0</html>', ...
