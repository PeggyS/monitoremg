...
% 		'Style', 'edit', 'String', '-100');
	...
	% manual adjust of mep beg/end lines
	uicontrol('Style', 'text', 'Units', 'normalized', ...
		'Position', [0.66,0.476,0.07,0.038], 'FontSize', analysis_edit_fontsize, ...
		'String', 'MEP times manually adjusted:')
	...
	app.h_chkbx_adjust_mep_end = uicontrol('Style', 'checkbox', 'Units', 'normalized', ...
		...
		'String', 'End', ...
		'Value', 0, ...
		'Callback', {@mep_manual_adjust, app, 'end'});
...
% 		'String', 'xxx', 'fontsize', mep_info_fontsize, 'Visible','off');    
	...
	% button to save figure of emg trace
	uicontrol('Style', 'pushbutton', 'Units', 'normalized', ...
		'Position', [0.875454545454545,0.475416666666666,0.056,0.0333], 'FontSize', analysis_edit_fontsize, ...
		'String', 'Save EMG Fig', ...
		'Callback', {@save_emg_trace, app}, ...
		'KeyPressFcn', {@data_fig_keypress, app})
	app.h_save_fig_suffix_chcbx = uicontrol('Style', 'checkbox', 'Units', 'normalized', ...
		'Position', [0.933030303030303,0.488541666666667,0.063939393939394,0.01875], 'FontSize', analysis_edit_fontsize, ...
		'String', 'Add file suffix:');
	app.h_save_fig_suffix_edit = uicontrol('Style', 'edit', 'Units', 'normalized', ...
		'Position', [0.934545454545455,0.464583333333333,0.060606060606061,0.022883333333333], 'FontSize', analysis_edit_fontsize, ...
		'String', '', 'HorizontalAlignment', 'left');

	% num std deviations 
	uicontrol('Style', 'text', 'Units', 'normalized', ...
		'Position', [0.914545454545455,0.432291666666666,0.087545454545454,0.022233333333333], 'Fontsize', analysis_label_fontsize, ...
	...
	app.h_autocompute_mep = uicontrol('Style', 'pushbutton', ...
		'Units', 'normalized', 'Position', [0.55,0.354,0.05,0.04], ...
		'Tag', 'autocompute_mep_pushbutton', ...
		'String', 'Auto MEP begin end', 'fontsize', analysis_label_fontsize, ...
		'Callback', {@auto_adjust_mep_beg_end, app}, ...
		'Visible', 'on');
	...
	app.h_save_computed_mep_info = uicontrol('Style', 'pushbutton', ...
		...
		'ForegroundColor', [0.00,0.38,0.63], ...
