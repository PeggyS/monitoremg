...
% 		'Style', 'edit', 'String', '-100');
	...
	app.h_edit_mep_max_so = uicontrol('Style', 'edit', ...
		...
		'Tag', 'edit_mep_max_so', ...
		'String', 'xxx', 'fontsize', mep_info_fontsize);    
	...
	app.h_compute_close_mep_begin_old = uicontrol('Style', 'pushbutton', ...
		...
		'String', '<html>Move MEP begin line to the left<br /> from MEP using derivative</html>', ...
	...
	app.h_compute_close_mep_end_old = uicontrol('Style', 'pushbutton', ...
		...
		'FontSize', large_button_fontsize, ...
		'String', '<html>Move MEP end line to the right<br />from MEP using derivative</html>', ...
	...
	app.h_compute_close_mep_begin = uicontrol('Style', 'pushbutton', ...
		...
		'FontSize', large_button_fontsize, ...
		'String', '<html>Move MEP begin line to the right where<br />mean line exceeds the prestim std dev</html>', ...
	...
	app.h_compute_close_mep_end = uicontrol('Style', 'pushbutton', ...
		...
		'FontSize', large_button_fontsize, ...
		'String', '<html>Move MEP end line to the left<br />where mean line exceeds std dev</html>', ...
		'Callback', {@pushbutton_adj_mep_end, app});

	app.h_save_computed_mep_info = uicontrol('Style', 'pushbutton', ...
		'Units', 'normalized', 'Position', [0.6,0.206,0.37,0.04], ...
		'Tag', 'savecomputed_mep_pushbutton', ...
		'String', 'Save MEP latency/MEP-max info for selected rows', 'fontsize', mep_info_fontsize, 'Value', 0, ...
		'Callback', {@save_computed_mep_info, app}, 'Visible', 'off');
