...
running_review_app = false;
if isprop(app, 'ReviewEMGRCUIFigure')
	running_review_app = true;
...
%  		'MenuBar', 'none');  %
	...
	if running_review_app == true
		uicontrol(app.sici_fig, ...
			...
			'String', 'MEP Latency', ...
			'Units', 'normalized', ...
			'Position', [0.04 0.07 0.149 0.04], ...
			'FontSize', 10);
		app.sici_ui.ts_latency = uicontrol(app.sici_fig, ...
			'Style', 'text', ...
			'String', '0', ...
			'Units', 'normalized', ...
			'Position', [0.22 0.07 0.122 0.04], ...
			'FontSize', 14);
		app.sici_ui.sici_latency = uicontrol(app.sici_fig, ...
			'Style', 'text', ...
			'String', '0', ...
			'Units', 'normalized', ...
			'Position', [0.49 0.07 0.122 0.04], ...
			'FontSize', 14);
		app.sici_ui.icf_latency = uicontrol(app.sici_fig, ...
			'Style', 'text', ...
			'String', '0', ...
			'Units', 'normalized', ...
			'Position', [0.75 0.07 0.122 0.04], ...
			'FontSize', 14);
	end
