...
switch cell_edit_data.Indices(2)
	...
	case magstim_col
	case bistim_col
		sprintf('rc_dp_tbl_edit_callback: bistim column %d edited', cell_edit_data.Indices(2))
	otherwise
		beep
		sprintf('rc_dp_tbl_edit_callback: unkown column %d edited', cell_edit_data.Indices(2))
end
return